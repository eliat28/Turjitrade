...
function Frame() {
  return (
    <div className="absolute content-stretch flex items-center left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]">
      <div className="h-[67px] relative shrink-0 w-[83px]" data-name="photo_2025-12-17 18.34.12-Photoroom 5">
      ...
      <div className="h-[57px] relative shrink-0 w-[253px]" data-name="photo_2025-12-17 18.34.32-Photoroom 2">
